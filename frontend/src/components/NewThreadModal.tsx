        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                className="min-h-[120px] w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
                value={message}
