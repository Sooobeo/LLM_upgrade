  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur">
      <div className="relative w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div className={createMutation.isPending ? "pointer-events-none opacity-40" : ""}>
          ...
          {createMutation.isPending && (
            <div className="absolute inset-0 z-50 flex flex-col items-center justify-center gap-4 rounded-2xl bg-white/80 backdrop-blur">
              <p className="text-sm font-semibold text-slate-700">
                Creating your thread…
              </p>

              {/* Progress bar */}
              <div className="h-2 w-2/3 overflow-hidden rounded-full bg-slate-200">
                <div
